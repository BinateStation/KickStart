...
class CommentRepository(private val commentApi: CommentApi) {
    ...
    fun getAll(): LiveData<Resource<List<CommentModel>>> {
        return object : NetworkBoundResource<List<CommentModel>, ApiRequest>() {
            ...
            override fun createCall() = commentApi.getAll()
