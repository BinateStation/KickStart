...
import static com.binatestation.kickstart.utils.Constants.END_URL_PHOTOS;
import static com.binatestation.kickstart.utils.Constants.KEY_DATA_MODEL;

public class PhotoListFragment extends SwipeListFragment implements JSONArrayResponseListener {
    ...
    private void getData() {
        ...
        JsonArrayRequestFactory requestFactory = JsonArrayRequestFactory.newInstance(END_URL_PHOTOS);
    ...
    public void onResponse(JSONArray response, long requestId) {
        ...
        getAdapter().setTypedData(Utils.parseJsonArray(response, PhotoModel.class));
    }
