...
import static com.binatestation.kickstart.utils.Constants.END_URL_POSTS;
import static com.binatestation.kickstart.utils.Constants.KEY_DATA_MODEL;

public class PostListFragment extends SwipeListFragment implements JSONArrayResponseListener {
    ...
    private void getData() {
        ...
        JsonArrayRequestFactory requestFactory = JsonArrayRequestFactory.newInstance(END_URL_POSTS);
    ...
    public void onResponse(JSONArray response, long requestId) {
        ...
        getAdapter().setTypedData(Utils.parseJsonArray(response, PostModel.class));
    }
