...
import static com.binatestation.kickstart.utils.Constants.KEY_DATA;
...
public class JsonObjectRequestFactory implements Response.Listener<JSONObject>, Response.ErrorListener {
    ...
    public void onResponse(JSONObject response) {
        ...
        if (mJsonObjectResponseListener != null) {
            mJsonObjectResponseListener.onResponse(response, mRequestId);
            return;
        }
        if (mJsonArrayResponseListener != null) {
            JSONArray dataJsonArray = response.optJSONArray(KEY_DATA);
        ...
        if (mStringResponseListener != null) {
            String dataString = response.optString(KEY_DATA);
