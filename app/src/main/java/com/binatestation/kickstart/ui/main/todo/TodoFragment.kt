...
class TodoFragment : ListFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter.itemViewTypeModels.add(
            ItemViewTypeModel(
                ...
                TodoViewHolder::class.java,
                TodoViewHolder.LAYOUT,
                AdapterTodoBinding::class.java
            )
        )
        todoViewModel.todos.observe(viewLifecycleOwner, Observer { it ->
            it.data?.let {
