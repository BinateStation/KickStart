 ...
 *
 * Last Updated at 19/5/20 10:41 AM.
 */
...
/**
 * A simple [SwipeListAddFragment] subclass. which can be used for [SearchView], [SwipeRefreshLayout] without Add [FloatingActionButton]
 */
open class SwipeListSearchFragment : SwipeListAddFragment() {
